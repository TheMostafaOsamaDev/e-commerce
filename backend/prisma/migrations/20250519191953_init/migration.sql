...
-- CreateEnum
CREATE TYPE "Category" AS ENUM ('ELECTRONICS', 'FASHION', 'HOME', 'BEAUTY', 'SPORTS', 'TOYS', 'BOOKS');

-- CreateEnum
CREATE TYPE "SubCategory" AS ENUM ('SMARTPHONES', 'LAPTOPS', 'TABLETS', 'HEADPHONES', 'CLOTHING', 'FOOTWEAR', 'FURNITURE', 'APPLIANCES', 'SKINCARE', 'MAKEUP', 'FITNESS', 'OUTDOORS', 'ACTION_FIGURES', 'PUZZLES', 'FICTION', 'NON_FICTION');
